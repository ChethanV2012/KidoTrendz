            ...
            {subscription ? (
              ...
              <div className="space-y-3">
                <input
                  ...
                  className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent text-sm text-gray-900 transition-all duration-200"
                />
                {errMsg && (
